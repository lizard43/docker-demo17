...
var websocketclient = {
    ...
    'onFail': function (message) {
        ...
        websocketclient.render.showError('Connect to MQTT failed: ' + message.errorMessage);
    },
...
//        console.log("onMessageArrived:" + message.payloadString + " qos: " + message.qos);
        ...
        subscription.callback(message.payloadString);
    ...
    'subscribe': function (topic, qosNr, subscriptionCallback) {
        ...
        var subscription = {'topic': topic, 'qos': qosNr, 'color': 0};
